...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~BTC0x0C8AqP2KDWIQ4Ri",  // Your bot's session ID (keep it secure)
    PREFIX: getConfig("PREFIX") || "2",  // Command prefix (e.g., "., / ! * - +")
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "254732994872",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "∅ÑË ĪÑ Ã MĪLLÍ∅Ñ",           // Owner's name
    DEV: process.env.DEV || "254732994872",                     // Developer's contact number
